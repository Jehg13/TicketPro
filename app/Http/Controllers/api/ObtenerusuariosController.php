...
class ObtenerusuariosController extends Controller
{
    ...
    private function consultaUsuarios()
    {
        return DB::table('users')
            ->leftJoin('numeros_empleado', 'numeros_empleado.login', '=', 'users.login')
            ->leftJoin('departamentos', 'departamentos.usuario_departamento', '=', 'users.login')
            ->leftJoin('oficinas', 'oficinas.id', '=', 'departamentos.oficina_id')
            ->leftJoin('empresas', 'empresas.id', '=', 'oficinas.empresa_id')
            ->select(
                'users.login',
                'users.name',
                'users.email',
