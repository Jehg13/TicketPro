document.addEventListener('alpine:init', () => {
    ...
    fetch(`/tickets/${this.selectedTicket.id}/tomar`, {
    ...
    .then(data => {
        ...
        /*
        |--------------------------------------------------------------------------
        | ACTUALIZAR TICKET DEL MODAL
        |--------------------------------------------------------------------------
        */

        this.selectedTicket.estado = data.estado;

        this.selectedTicket.tomado_por = data.tomado_por;

        this.selectedTicket.fecha_tomado = data.fecha_tomado;


        /*
        |--------------------------------------------------------------------------
        | ACTUALIZAR TICKET DE LA TABLA
        |--------------------------------------------------------------------------
        */

        this.ticketsActualizados[this.selectedTicket.id] = {

            estado: data.estado,

            tomado_por: data.tomado_por,

            fecha_tomado: data.fecha_tomado
    ...
    .catch(error => {
        ...
        ticketActualizado(id) {
            ...
            return this.ticketsActualizados[id] ?? null;
        ...
        obtenerEvidencias(ticket) {
            ...
            if (
                Array.isArray(ticket.evidencia)
            ) {
            ...
            if (ticket.evidencia) {
                ...
                if (
                    typeof ticket.evidencia === 'string'
                ) {
