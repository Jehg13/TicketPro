...
<div class="flex flex-col items-center gap-3 text-center sm:flex-row sm:items-start sm:text-left">                <div class="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-white/5 text-white">
                ...
                <div>
                    <h1 class="text-2xl font-extrabold text-white sm:text-3xl">¿Necesitas ayuda?</h1>
            ...
            {{-- Ilustración del agente, pegada a la fila de tarjetas --}}
            <div class="hidden h-44 w-48 shrink-0 sm:block md:h-52 md:w-56 lg:h-64 lg:w-64">
                <img
                    src="{{ asset('storage/images/cymez-sin-fondo.png') }}"
                    alt="Agente de soporte TicketPro"
        ...
        <section class="mt-10 sm:-mt-20 lg:-mt-34">
            ...
            <div class="flex items-center justify-center gap-2.5 sm:justify-start">
                ...
                <h2 class="text-xl font-bold text-white sm:text-2xl">Contacta a soporte</h2>
            </div>

            <div class="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">

                {{-- ---------- CORREO ---------- --}}
                <div class="rounded-2xl border border-blue-600/70 bg-[#0b0f2a] p-5 shadow-[0_0_25px_rgba(37,99,235,0.12)]">
                    <div class="flex flex-col items-center text-center sm:flex-row sm:items-start sm:gap-4 sm:text-left">
                        <div class="flex h-16 w-16 shrink-0 items-center justify-center rounded-full bg-black sm:h-11 sm:w-11">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 text-white sm:h-5 sm:w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <div class="mt-3 sm:mt-0">
                            <h3 class="text-lg font-bold text-white">Correo electrónico</h3>
                            <p class="mt-1 text-sm leading-snug text-slate-400">
                                Envíanos un correo y te responderemos a la brevedad
                            </p>
                            <p class="mt-3 text-sm font-semibold text-white">Soporte@cymez.com</p>
                        </div>
                    </div>
                ...
                <div class="rounded-2xl border border-blue-600/70 bg-[#0b0f2a] p-5 shadow-[0_0_25px_rgba(37,99,235,0.12)]">
                    <div class="flex flex-col items-center text-center sm:flex-row sm:items-start sm:gap-4 sm:text-left">
                        <div class="flex h-16 w-16 shrink-0 items-center justify-center rounded-full bg-black sm:h-11 sm:w-11">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 text-green-500 sm:h-5 sm:w-5" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <div class="mt-3 sm:mt-0">
                            ...
                            <p class="mt-1 text-sm leading-snug text-slate-400">
                                Escríbenos a whatsapp para una atención mas rápida
                            </p>
                            <p class="mt-3 text-sm font-semibold text-green-500">(899) 123 4567</p>
                        </div>
                    </div>
                ...
                {{-- ---------- LLAMAR ---------- --}}
                <div class="rounded-2xl border border-blue-600/70 bg-[#0b0f2a] p-5 shadow-[0_0_25px_rgba(37,99,235,0.12)] sm:col-span-2 lg:col-span-1">
                    <div class="flex flex-col items-center text-center sm:flex-row sm:items-start sm:gap-4 sm:text-left">
                        <div class="flex h-16 w-16 shrink-0 items-center justify-center rounded-full bg-black sm:h-11 sm:w-11">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 text-fuchsia-500 sm:h-5 sm:w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <div class="mt-3 sm:mt-0">
                            <h3 class="text-lg font-bold text-white">Llamar al soporte</h3>
                            <p class="mt-1 text-sm leading-snug text-slate-400">
                                Llamanos directamente en nuestro horario de atención
                            </p>
                            <p class="mt-3 text-sm font-semibold text-fuchsia-400">(899) 123 4567</p>
                        </div>
                    </div>
        ...
        <section class="mt-10">
            ...
            <div class="flex items-center justify-center gap-2.5 sm:justify-start">
                ...
                <h2 class="text-xl font-bold text-white sm:text-2xl">Preguntas frecuentes</h2>
            </div>
            ...
            <div class="mt-4 grid grid-cols-1 gap-3 lg:grid-cols-2 lg:items-start">
                ...
                @php
                    $faqs = [
                        [
                            'q' => '¿Como puedo dar seguimiento a un ticket?',
                        ...
                        [
                            'q' => '¿Cuanto tiempo se tarda en resolver un ticket?',
                        ...
                        [
                            'q' => '¿Que información debo tener en mi reporte?',
                        ...
                        [
                            'q' => '¿Como se si mi ticket esta solucionado?',
                ...
                @foreach ($faqs as $index => $faq)
                    <div class="rounded-xl border border-blue-600/60 bg-[#0b0f2a] transition hover:border-blue-500">
                        <button type="button"
                            ...
                            <span>{{ $faq['q'] }}</span>
                            <svg id="faq-icon-{{ $index }}" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0 text-blue-500 transition-transform duration-200" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round">
        ...
        <section class="mt-8">
            ...
            @php
                ...
                $esDiaHabil = $ahora->isWeekday(); // lunes(1) a viernes(5)
                $horaInicio = $ahora->copy()->setTime(8, 0);
                $horaFin = $ahora->copy()->setTime(17, 45);
                $disponible = $esDiaHabil && $ahora->between($horaInicio, $horaFin);
            @endphp

            <div class="flex flex-col gap-4 rounded-2xl bg-[#0b0f2a] p-5 sm:flex-row sm:items-center sm:justify-between">

                <div class="flex items-center gap-3">
                    <div class="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-white text-[#0b0f2a]">
                    ...
                    <div>
                        <p class="text-base font-bold text-white">Hora de atención</p>
                        <p class="text-sm text-slate-400">Lunes a Viernes de 8:00 AM a 17:45 PM</p>
                    </div>
                </div>
                ...
                @if ($disponible)
                    <div class="flex items-center gap-2 sm:pr-2">
                        ...
                        <span class="text-sm font-bold text-green-400">Estamos disponibles</span>
                    </div>
                @else
                    <div class="flex items-center gap-2 sm:pr-2">
                        <span class="relative flex h-2.5 w-2.5">
                        ...
                        <span class="text-sm font-bold text-red-400">No estamos disponibles</span>
                    </div>
                @endif
