                            ...
                            <button id="profile-button" type="button" @click="perfilAbierto = !perfilAbierto"
                                ...
                                <div class="text-left leading-tight hidden sm:block">
                                    ...
                                    <p class="text-[10px] text-blue-400 font-medium">
                                        {{ optional(auth()->user()->departamento)->nombre ?? 'Sin departamento' }}</p>
                                </div>
                        ...
                        <div x-show="openModalSolucion" x-transition @click.stop
                                    ...
                                    <div class="min-w-0">
                                        <div class="flex items-center gap-3 mb-2">
                                            ...
                                            <span class="text-sm font-bold text-white"
                                                x-text="'#' + (ticketSolucion?.folio ?? '—')"></span>
                                        </div>
                                        <h2 class="text-xl font-bold text-white truncate"
                                            x-text="ticketSolucion?.titulo ?? 'Ticket'"></h2>
                            ...
                            <div class="p-6 space-y-6 max-h-[75vh] overflow-y-auto custom-scrollbar">
                                <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                                    <div class="p-4 rounded-xl bg-[#060c21] border border-slate-800">
                                        <span class="text-[10px] text-slate-500 uppercase font-semibold">Folio</span>
                                        <p class="text-sm font-bold text-white mt-1"
                                            x-text="ticketSolucion?.folio ?? '—'"></p>
                                    </div>

                                    <div class="p-4 rounded-xl bg-[#060c21] border border-slate-800">
                                        <span class="text-[10px] text-slate-500 uppercase font-semibold">Título</span>
                                        <p class="text-sm font-bold text-white mt-1 truncate"
                                            x-text="ticketSolucion?.titulo ?? '—'"></p>
                                    </div>

                                    <div class="p-4 rounded-xl bg-[#060c21] border border-slate-800">
                                        <span class="text-[10px] text-slate-500 uppercase font-semibold">Tomado
                                            por</span>
                                        <p class="text-sm font-bold text-white mt-1"
                                            x-text="ticketSolucion?.tomado_por?.name ?? '—'"></p>
                                    </div>
                                </div>

                                <div>
                                    <label class="block text-xs font-semibold text-slate-300 mb-2">Estado</label>
                                    <div class="w-full bg-[#060c21] border border-slate-800 rounded-xl px-4 py-3 text-xs"
                                        :class="ticketSolucion?.estado === 'solucionado' ? 'text-emerald-400' :
                                            ...
                                            'text-slate-400'"
                                        x-text="ticketSolucion?.estado === 'solucionado' ? 'Solucionado' :
                                            ticketSolucion?.estado === 'cancelado' ? 'Cancelado' :
                                            ticketSolucion?.estado === 'en proceso' ? 'En proceso' : 'Pendiente'">
                                    </div>
                                </div>

                                <div>
                                    <label class="block text-xs font-semibold text-slate-300 mb-2">Solución
                                        aplicada</label>
                                ...
                                <div x-show="modalSolucionSoloLectura">
                                                ...
                                                <div class="flex items-center gap-3 min-w-0">
                                                    ...
                                                    <div class="min-w-0">
                                                        <p class="text-xs text-white truncate"
                                                            x-text="archivo.nombre || nombreArchivo(archivo)"></p>
                                                        <p class="text-[10px] text-slate-500">Evidencia registrada</p>
                                                    </div>
                                                </div>
                                    ...
                                    <div x-show="!Array.isArray(evidenciasSolucion) || evidenciasSolucion.length === 0"
                                        ...
                                        <i data-lucide="image-off" class="w-6 h-6 mx-auto mb-2 text-slate-600"></i>
                                        <p class="text-xs text-slate-500">No hay evidencia registrada.</p>
                                    </div>
                                </div>

                                <div>
                                    <label class="block text-xs font-semibold text-slate-300 mb-3">¿El problema fue
                                        solucionado?</label>
                                ...
                                <div>
                                    <label class="block text-xs font-semibold text-slate-300 mb-2">Fecha de
                                        solución</label>
                                ...
                                <div class="border-t border-slate-800 pt-6">
                                    <h3 class="text-sm font-bold text-white mb-1">Conformidad del usuario</h3>
                                    ...
                                    <div class="mb-5">
                                        <label class="block text-xs font-semibold text-slate-300 mb-2">Persona que
                                            levantó el ticket</label>
                                        <div
                                    ...
                                    <div>
                                        <div x-show="!modalSolucionSoloLectura">
                                            <div class="flex items-center justify-between mb-2">
                                                <label class="block text-xs font-semibold text-slate-300">Firma</label>
                                        ...
                                        <div x-show="modalSolucionSoloLectura">
                                            <label
                                                class="block text-xs font-semibold text-slate-300 mb-2">Firma</label>
                                            <div
                            ...
                            <div
                                ...
                                <button x-show="!modalSolucionSoloLectura" type="button" @click="guardarSolucion()"
                                    ...
                                    <span x-text="guardandoSolucion ? 'Guardando...' : 'Guardar solución'"></span>
                                </button>
                            </div>
                        </div>
                    </div>
