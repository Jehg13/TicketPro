...
<body class="bg-[#070b19] text-white font-sans h-screen flex antialiased overflow-hidden">
    ...
    <aside class="w-64 bg-[#0a0f24] border-r border-slate-800/60 p-6 flex flex-col justify-between hidden md:flex h-screen shrink-0 overflow-hidden">
    ...
    <main class="flex-1 h-screen min-w-0 overflow-y-auto overflow-x-hidden p-6 md:p-8">
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <header class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                ...
                <div class="flex items-center gap-4 self-end md:self-auto">
                    ...
                    <div class="flex items-center gap-6">
                        ...
                        <div class="relative inline-block text-left">
                            ...
                            <div id="notif-dropdown"
                                ...
                                <div class="p-4 flex items-center justify-between">
                                    ...
                                    <button class="text-xs text-indigo-400 hover:text-indigo-300 font-medium transition-colors">
                                        Marcar leídas
                                    </button>
                        ...
                        <div class="flex items-center gap-3 bg-slate-900/80 border border-slate-800 rounded-full p-1.5 pr-4">
                            ...
                            <i data-lucide="chevron-down"
                                class="w-4 h-4 text-slate-400 ml-1"></i>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mb-8">
                ...
                <div class="bg-[#0b1026]/80 border border-blue-900/40 rounded-2xl p-4 relative overflow-hidden backdrop-blur-sm">
            ...
            <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-6">
                ...
                <div class="flex items-center gap-1 bg-[#0b1026] border border-slate-800 p-1.5 rounded-2xl overflow-x-auto">

                    <button type="button"
                        class="px-5 py-2 rounded-xl text-xs font-semibold bg-blue-600 text-white shadow-md shadow-blue-600/30 whitespace-nowrap">
                        Todos
                    </button>

                    <button type="button"
                        class="px-5 py-2 rounded-xl text-xs font-medium text-slate-400 hover:text-white transition whitespace-nowrap">
                        Pendientes
                    </button>
                    ...
                    <button type="button"
                        class="px-5 py-2 rounded-xl text-xs font-medium text-slate-400 hover:text-white transition relative whitespace-nowrap">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div class="relative flex-1 sm:w-64">
                        ...
                        <i data-lucide="search"
                            class="absolute left-3.5 top-3 w-4 h-4 text-slate-500"></i>

                        <input type="text"
                            placeholder="Buscar..."
                            class="w-full bg-[#0b1026] border border-slate-800 text-xs rounded-xl pl-10 pr-4 py-2.5 text-slate-200 placeholder-slate-500 focus:outline-none focus:border-blue-500">
                ...
                <div class="overflow-x-auto">
                    ...
                    <table class="w-full text-left border-collapse">
                        ...
                        <thead>
                            ...
                            <tr class="border-b border-slate-800 text-[11px] uppercase tracking-wider text-slate-400 font-semibold bg-slate-900/30">
                        ...
                        <tbody class="divide-y divide-slate-800/60 text-xs">
                            ...
                            @forelse ($tickets as $ticket)
                                ...
                                $ticketData = $ticket->toArray();
                                    ...
                                    $comentariosData = $ticket->historialComentarios->map(function ($comentario) {
                                ...
                                <tr class="hover:bg-slate-800/20 transition">
                                    ...
                                    <td class="py-4 px-6 whitespace-nowrap">
                                        ...
                                        <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg text-[10px] font-semibold border {{ $configPrioridad['texto'] }} {{ $configPrioridad['fondo'] }} {{ $configPrioridad['borde'] }}">

                                            <i data-lucide="{{ $configPrioridad['icono'] }}"
                                                class="w-3 h-3"></i>
                                    ...
                                    <td class="py-4 px-6 whitespace-nowrap">
                                        ...
                                        @if ($ticket->estado === 'solucionado')
                                            ...
                                            <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-[#133d28] text-green-300 border border-green-500/40">
                                                ✓ Solucionado
                                            </span>

                                        @elseif ($ticket->estado === 'pendiente')

                                            <span class="inline-flex items-center justify-center min-w-[100px] px-3 py-1 rounded-full text-xs font-semibold bg-[#4a4213] text-yellow-300 border border-yellow-500/40">
                                        ...
                                        @elseif ($ticket->estado === 'en proceso')
                                            ...
                                            <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-[#1d2757] text-blue-300 border border-blue-500/40">
                                        ...
                                        @elseif ($ticket->estado === 'cancelado')
                                            ...
                                            <span class="inline-flex items-center justify-center min-w-[100px] px-3 py-1 rounded-full text-xs font-semibold bg-[#4d1616] text-red-300 border border-red-500/40">
                                                Cancelado
                                            </span>
                    ...
                    <div x-show="openModal"
                        ...
                        <div x-show="openModal"
                            ...
                            <div class="p-6 overflow-y-auto custom-scrollbar flex-1 space-y-6">
                                ...
                                <div class="grid grid-cols-2 md:grid-cols-5 gap-4 p-4 rounded-2xl bg-[#060c21] border border-blue-500/40">
                                ...
                                <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
                                            ...
                                            <div class="space-y-3 text-xs">
                                                ...
                                                <div class="pt-2 space-y-2">
                                                    ...
                                                    <div class="p-2.5 rounded-xl bg-[#030712] border border-slate-800/80">
                                                        ...
                                                        <div class="flex items-center gap-1.5 text-[10px] text-slate-400 font-semibold mb-0.5">
                                                        ...
                                                        <div class="text-xs text-slate-400"
                                                            x-text="selectedTicket?.tomado_por ? 'Ticket asignado' : 'Aún sin tomar'">
                                                        </div>
                                                ...
                                                <div class="flex items-center gap-3 overflow-x-auto pb-1">
                                                    ...
                                                    <template x-for="(archivo, index) in evidencias" :key="index">
                                                        ...
                                                        <a :href="archivoUrl(archivo)"
                                                            ...
                                                            <div class="flex items-center justify-between gap-1 text-[9px] text-slate-300 pt-2 border-t border-slate-800">

                                                                <span class="truncate"
                                                                    x-text="nombreArchivo(archivo)">
                                                                </span>

                                                                <span class="px-1 py-0.5 rounded bg-blue-600 text-white font-bold text-[8px] shrink-0"
                                    ...
                                    <div class="lg:col-span-6 p-5 rounded-2xl bg-[#060c21] border border-blue-500/30 flex flex-col min-h-[600px]">
                                        ...
                                        <form id="formComentario"
                                            ...
                                            <div class="relative flex-1">
                                                ...
                                                <input type="file"
                                                    ...
                                                    @change="archivoAdjunto = $event.target.files[0]"
                                                    class="hidden">
                                                ...
                                                <div class="flex items-start gap-3">
                                                    ...
                                                    <div class="flex-1 min-w-0">
                                                        ...
                                                        <div class="flex items-center gap-2 mb-1 flex-wrap">
                                                            ...
                                                            <span class="px-2 py-0.5 rounded-full text-[9px] font-semibold bg-indigo-600/30 text-indigo-300 border border-indigo-500/40"
                                                        ...
                                                        <template x-if="comentario.archivo">
                                                            ...
                                                            <template x-if="esImagen(comentario.archivo)">
                                                                ...
                                                                <a :href="comentario.url_archivo"
                                                                    ...
                                                                    <div class="px-2 py-1.5 flex items-center justify-between gap-2 border-t border-slate-800">
                                                        ...
                                                        <template x-if="comentario.archivo && !esImagen(comentario.archivo)">
                                                            ...
                                                            <a :href="comentario.url_archivo"
                                                                ...
                                                                <div class="flex items-center justify-between gap-2 text-[9px] text-slate-300 pt-1 border-t border-slate-800">
                            ...
                            <div class="p-5 border-t border-slate-800/80 bg-[#030712] flex items-center justify-between shrink-0">
                                ...
                                <button type="button"
                                    class="px-6 py-2.5 bg-blue-600 hover:bg-blue-500 text-white text-xs font-semibold rounded-xl shadow-lg transition flex items-center gap-2">
            ...
            Alpine.data('ticketModal', () => ({
                ...
                obtenerEvidencias(ticket) {
                    ...
                    if (ticket.evidencia) {
                        ...
                        if (typeof ticket.evidencia === 'object') {
                            return Object.values(ticket.evidencia);
                        }
                ...
                archivoUrl(archivo) {
                    ...
                    if (typeof archivo === 'object') {
                        ...
                        if (archivo.archivo) {
                            return this.archivoUrl(archivo.archivo);
                        }
