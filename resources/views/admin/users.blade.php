            ...
            <header
                ...
                <div class="min-w-0">
                    ...
                    <p
                        class="text-xs
                               ...
                               mt-1
                               max-w-2xl">
                        Consulta y administra la información de los usuarios del
                        sistema
                    </p>
               ...
               z-[99999]"
                   ...
                   text-left">
                                ...
                                <i data-lucide="settings" class="w-5 h-5 text-slate-400">
                                </i>
                       ...
                       text-slate-500
                       transition-transform duration-200"
                                    :class="{ 'rotate-180': configuracionAbierta }">
                                </i>
                            </button>

                            <div x-show="configuracionAbierta" x-transition
                                class="border-t border-[#1e295d]
                   bg-[#0b1026]/50">
                       ...
                       transition">
                                    ...
                                    <i data-lucide="circle-user-round" class="w-4 h-4 text-blue-400">
                                    </i>
                       ...
                       transition">
                                    ...
                                    <i data-lucide="database-backup" class="w-4 h-4 text-emerald-400">
                                    </i>
                            ...
                            <div class="border-t border-[#1e295d]">
                            </div>
                        ...
                        <table class="w-full min-w-[650px] text-left text-xs">
                            ...
                            <thead>
                                <tr class="text-slate-400 border-b border-slate-800/80">
                                    ...
                                    <th class="pb-3 px-2 sm:px-3 font-semibold whitespace-nowrap">
                                        Usuario
                                    </th>
                                    ...
                                    <th class="pb-3 px-2 sm:px-3 font-semibold text-center whitespace-nowrap">
                                        Estado
                                    </th>
                            ...
                            <tbody class="divide-y divide-slate-800/50 text-slate-300">
                                ...
                                @forelse($usuarios as $usuario)
                                    <tr class="hover:bg-slate-800/20 transition"
                                        ...
                                        {{-- USUARIO --}}
                                        <td class="py-3 sm:py-4 px-2 sm:px-3">

                                            <div class="flex items-center gap-2 sm:gap-3 min-w-[180px]">
                                ...
                                ring-2 ring-blue-500/20 flex-shrink-0">

                                                <div class="min-w-0">

                                                    <p
                                                        class="text-white font-medium truncate max-w-[150px] sm:max-w-[220px]">
                                                        {{ $usuario->name }}
                                                    </p>

                                                    <p
                                                        class="text-[9px] sm:text-[10px] text-slate-500 truncate max-w-[150px] sm:max-w-[220px]">
                                                        {{ $usuario->email }}
                                                    </p>
                                        ...
                                        <td class="py-3 sm:py-4 px-2 sm:px-3">
                                            ...
                                            @if ($rol === 'gerente ti')
                                                <span
                                                    class="inline-flex px-2 sm:px-2.5 py-1 rounded-full
                                ...
                                border border-blue-500/20 whitespace-nowrap">
                                                    Técnico
                                                </span>
                                            @else
                                                <span
                                ...
                                border border-indigo-500/20 whitespace-nowrap">
                                        ...
                                        {{-- ESTADO --}}
                                        <td class="py-3 sm:py-4 px-2 sm:px-3 text-center">

                                            @if (strtoupper(trim((string) $usuario->active)) === 'Y')
                                                <span
                                                    class="inline-flex items-center gap-1 sm:gap-1.5
                                px-2 sm:px-2.5 py-1 rounded-full
                                text-[9px] sm:text-[10px] font-medium
                                bg-emerald-500/10 text-emerald-400
                                border border-emerald-500/20 whitespace-nowrap">
                                ...
                                border border-rose-500/20 whitespace-nowrap">
                                        ...
                                        {{-- DEPARTAMENTO --}}
                                        <td class="py-3 sm:py-4 px-2 sm:px-3 text-slate-400">

                                            <span class="block truncate max-w-[130px] sm:max-w-[200px]">
                                        ...
                                        <td class="py-3 sm:py-4 px-2 sm:px-3">
                                            ...
                                            <div class="flex items-center justify-center gap-1.5 sm:gap-2">
                                                ...
                                                <button type="button" title="Ver usuario"
                                                    ...
                                                    class="w-7 h-7 sm:w-8 sm:h-8 rounded-lg
                                flex items-center justify-center
                                ...
                                transition-all flex-shrink-0">
                                                    <i data-lucide="eye"
                                                        class="w-3.5 h-3.5 sm:w-4 sm:h-4 pointer-events-none"></i>
                                                </button>
                                                ...
                                                <button type="button" title="Eliminar usuario"
                                                    @click.prevent="abrirModalEliminar(
                                    @js($usuario->login),
                                    @js($usuario->name)
                                )"
                                                    class="w-7 h-7 sm:w-8 sm:h-8 rounded-lg
