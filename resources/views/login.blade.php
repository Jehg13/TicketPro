...
<body class="h-full w-screen overflow-hidden">
    ...
    <div class="relative h-screen w-screen flex">
        ...
        {{-- ================= FONDO: dos mitades (imágenes) ================= --}}
        <div class="absolute inset-0 flex">
            <img src="{{ asset('storage/images/login-left.png') }}"
                 alt="Fondo lateral izquierdo"
                 class="w-1/2 h-full object-cover">
            <img src="{{ asset('storage/images/login-right.png') }}"
                 alt="Fondo lateral derecho"
                 class="w-1/2 h-full object-cover">
        </div>

        {{-- overlay para oscurecer un poco y unificar contraste --}}
        <div class="absolute inset-0 bg-black/10 pointer-events-none"></div>

        {{-- ================= TARJETA DE LOGIN ================= --}}
        <div class="relative z-10 flex items-center justify-center w-full h-full px-4">
            <div class="w-full max-w-md bg-[#0b0f19]/95 border border-blue-600 rounded-2xl shadow-[0_0_40px_rgba(37,99,235,0.25)] px-8 py-7">
                ...
                <div class="text-center mt-5">
                    ...
                    <p class="text-gray-400 text-sm mt-1 leading-snug">
                        Inicia sesión para continuar<br>y gestionar tus tickets
                    </p>
                </div>
                ...
                <form method="POST" action="{{ route('login.process') }}" class="mt-5 space-y-3">
                    ...
                    <div>
                        ...
                        <input id="email" name="email" type="email" required autofocus
                               value="{{ old('email') }}"
                               class="w-full rounded-lg bg-[#161b28] border border-blue-600/70 text-white text-sm px-3 py-2.5
                                      placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-brandblue-500 focus:border-brandblue-500">
                        @error('email')
                    ...
                    <button type="submit"
                            class="w-full mt-1 flex items-center justify-center gap-2 rounded-lg py-2.5
                                   text-white text-sm font-bold tracking-wide uppercase
                                   bg-gradient-to-r from-brandblue-400 to-brandblue-600
                                   hover:from-brandblue-500 hover:to-brandblue-600
                                   shadow-[0_4px_14px_rgba(37,99,235,0.5)] transition">
                        Iniciar sesión
                ...
                <div class="mt-4 border border-blue-600/70 rounded-xl bg-[#0d1220] px-4 py-3 flex items-start gap-3">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-9 h-9 flex-shrink-0" viewBox="0 0 24 24" fill="white">
    ...
    @if (session('error'))
        <div id="errorModal"
            ...
            <div class="relative w-full max-w-sm
                        bg-[#0b0f19]/95 border border-red-500/40
                        rounded-2xl shadow-[0_0_40px_rgba(239,68,68,0.2)]
                        px-6 py-6">
                <button type="button"
                        onclick="closeErrorModal()"
                        class="absolute right-3 top-3 flex h-7 w-7
                ...
                <div class="mx-auto flex h-14 w-14 items-center justify-center
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7 text-red-400"
                         viewBox="0 0 24 24" fill="none" stroke="currentColor"
                ...
                <div class="mt-4 text-center">
                    <p class="text-white text-base font-bold">No se pudo iniciar sesión</p>
                ...
                <button type="button"
                        onclick="closeErrorModal()"
                        class="mt-5 w-full rounded-lg py-2.5
                               text-white text-sm font-bold tracking-wide uppercase
                               bg-gradient-to-r from-brandblue-400 to-brandblue-600
                               hover:from-brandblue-500 hover:to-brandblue-600
                               shadow-[0_4px_14px_rgba(37,99,235,0.5)] transition">
