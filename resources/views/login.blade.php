...
<body class="h-full w-screen overflow-hidden">
    ...
    <div class="relative h-screen w-screen flex">
        <div class="absolute inset-0 flex">
            <img src="{{ asset('storage/images/login-left.png') }}" alt="Fondo lateral izquierdo" class="w-1/2 h-full object-cover">
            <img src="{{ asset('storage/images/login-right.png') }}" alt="Fondo lateral derecho" class="w-1/2 h-full object-cover">
        </div>
    ...
    @if (session('error'))
        <div
            ...
            <div
                ...
                <div class="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-red-500/10 border border-red-500/30 shadow-inner shadow-red-500/10">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
