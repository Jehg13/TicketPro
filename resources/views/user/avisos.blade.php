...
<div class="px-6 my-6">
    ...
    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-2 overflow-x-auto pb-2 lg:pb-0">
            ...
            <button
                type="button"
                @click="filtroTipo = 'mantenimiento'"
...
<div class="px-6 pb-10">
    ...
    <div class="bg-[#0f1535] rounded-2xl border border-[#1e295d] p-5 sm:p-6 space-y-4">
        ...
        @forelse($avisos ?? [] as $aviso)
            ...
            <div
                ...
                <div class="flex flex-col sm:flex-row items-start gap-4 flex-1">
                    ...
                    <!-- ICONO -->
                    <div
                        class="w-16 h-16 sm:w-20 sm:h-20 rounded-xl flex items-center justify-center shrink-0"
        ...
        <div
            x-cloak
            x-show="hayAvisos() && !hayAvisosVisibles()"
            x-transition.opacity.duration.200ms
            ...
            <button
                type="button"
                @click="filtroTipo = 'todos'; busqueda = ''"
    ...
    <div x-cloak x-show="modalAbierto" x-transition.opacity @keydown.escape.window.prevent="cerrarAviso()"
    ...
    function avisosUsuario() {
        ...
        return {
            ...
            mostrarAviso(tipo, titulo, descripcion) {
                ...
                // solamente importa el filtro por tipo.
