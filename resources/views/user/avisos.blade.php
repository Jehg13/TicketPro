                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    ...
                    <div class="bg-[#080d22] border border-[#1e295d] rounded-xl p-4">
                        ...
                        <span class="inline-flex mt-2 px-3 py-1 rounded-md text-xs font-semibold"
                            :class="{
                                'bg-red-950 border border-red-500 text-red-400': avisoSeleccionado.importancia === 'critica',
                                'bg-orange-950 border border-orange-500 text-orange-400': avisoSeleccionado.importancia === 'alta',
                                'bg-yellow-950 border border-yellow-500 text-yellow-400': avisoSeleccionado.importancia === 'media',
                                'bg-slate-800 border border-slate-600 text-slate-300': avisoSeleccionado.importancia === 'normal'
                            }"
