        ...
        <main
            ...
            <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                <div class="flex items-center gap-3">
                    <button type="button" onclick="toggleSidebar()" class="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-[#151b3b] text-white transition hover:bg-[#1c244d] lg:hidden">
            ...
            <div class="mt-8 grid grid-cols-1 gap-6 pb-8 lg:grid-cols-12">
                <div class="order-1 rounded-xl border border-[#1e295d] bg-[#0f1535] p-5 shadow-lg lg:order-2 lg:col-span-7">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="rounded-xl border border-fuchsia-500/40 bg-[#4a174f]/40 px-4 py-1.5 text-center shadow-[0_0_15px_rgba(217,70,239,0.2)]">
                ...
                <div  class="order-3 rounded-xl border border-[#1e295d] bg-[#0f1535] p-5 shadow-lg lg:order-4 lg:col-span-7">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-2.5">
                            <div class="flex h-8 w-8 items-center justify-center rounded-lg bg-[#151b3b] text-white">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24"
                        ...
                        <div class="mt-3 grid grid-cols-2 gap-x-3 gap-y-3 text-sm">
                           ...
                           text-xs font-bold text-blue-400">
                            ...
                            <div>
                                ...
                                <p class="font-bold text-white">{{ $ultimoTicket['fecha_asignacion'] ?? 'N/A' }}</p>
                            </div>
                            <div>
                ...
                <div class="order-6 rounded-2xl border border-[#1e295d] bg-[#0f1535] p-5 shadow-lg lg:col-span-7">
                    ...
                    <div x-data="avisosModal()" @keydown.escape.window="cerrarAviso()" class="relative">
                        <div class="mt-4 space-y-2.5">
                            @forelse ($avisos as $aviso)
                                ...
                                <div
                                    ...
                                    <div class="flex min-h-[112px] items-center gap-4 p-3.5 sm:p-4">
                                        <div class="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl border {{ $config['iconBg'] }} {{ $config['iconBorder'] }} {{ $config['iconText'] }} shadow-inner transition-transform duration-200 group-hover:scale-[1.03]">
                            ...
                            @empty
                                <div class="rounded-xl border border-dashed border-[#26335f] bg-[#0b102b]/60 px-5 py-8 text-center">
                                    <div
                                    ...
                                    <p class="mt-1 text-xs text-gray-600">No se han publicado avisos recientemente.</p>
                                </div>
                            @endforelse
                        </div>
                        <div x-cloak x-show="abierto" x-transition.opacity
                            ...
                            <div x-cloak x-show="abierto" @keydown.escape.window="cerrarAviso()"
                                ...
                                <div x-show="abierto" x-transition:enter="transition ease-out duration-200"
                                    ...
                                    <div class="border-b border-[#1e295d] bg-gradient-to-r from-[#101638] to-[#0c122e] px-5 py-4 sm:px-6">
                                                    ...
                                                    <span x-show="aviso.importancia"
                                                        ...
                                                        <span class="h-1.5 w-1.5 rounded-full"
                                                            :class="{
                                                                ...
                                                                'bg-blue-400': aviso.importancia === 'normal'}"></span>
                                    ...
                                    <div class="max-h-[65vh] overflow-y-auto px-5 py-5 sm:px-6">
                                        <div>
                                            <div class="mb-2 flex items-center gap-2">
                                                ...
                                                <p class="text-[10px] font-bold uppercase tracking-[0.18em] text-gray-500">Descripción</p>
                                            </div>
                                            <div class="relative overflow-hidden rounded-xl border border-[#1e295d] bg-[#080d24] p-4">
                                                <div class="absolute left-0 top-0 h-full w-[2px]" :class="colorTipo()"></div>
                                                <p class="whitespace-pre-line text-sm leading-6 text-gray-300" x-text="aviso.descripcion || 'Sin descripción disponible.'"></p>
                                            </div>
                                        </div>
                                        <div class="mt-5">
                                            <div class="mb-3 flex items-center gap-2">
                                                <div class="h-1 w-5 rounded-full bg-blue-500"></div>
                                                <p class="text-[10px] font-bold uppercase tracking-[0.18em] text-gray-500">Información del aviso</p>
                                            </div>
                                            <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
                                                <div
                                                    ...
                                                    <div class="flex items-center gap-3">
                                                        ...
                                                        <div class="min-w-0">
                                                            <p class="text-[9px] font-bold uppercase tracking-wider text-gray-600">Fecha</p>
                                                            <p class="mt-0.5 text-xs font-semibold text-gray-300" x-text="formatearFecha(aviso.fecha_inicio)"></p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div
                                                    ...
                                                    <div class="flex items-center gap-3">
                                                        ...
                                                        <div class="min-w-0">
                                                            <p class="text-[9px] font-bold uppercase tracking-wider text-gray-600">Hora</p>
                                                            <p class="mt-0.5 text-xs font-semibold text-gray-300" x-text="formatearHora(aviso.fecha_inicio)"></p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div
                                                    ...
                                                    <div class="flex items-start gap-3">
                                                        ...
                                                        <div class="min-w-0">
                                                            <p class="text-[9px] font-bold uppercase tracking-wider text-gray-600">Dirigido a</p>
                                                            <p class="mt-0.5 text-xs font-semibold leading-5 text-gray-300" x-text="obtenerAfectados()"></p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <template x-if="aviso.archivo">
                                                    <div class="mt-5">
                                                        <p class="mb-2 text-xs font-bold uppercase text-gray-500">Archivo adjunto</p>
