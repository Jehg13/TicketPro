...
<body class="h-screen overflow-hidden bg-[#02030a]">
    ...
    <main class="h-screen lg:grid lg:grid-cols-[38%_62%]">
        ...
        <section
            ...
            <div class="relative z-10 mx-auto w-full max-w-md">
                ...
                <div class="mb-4 flex items-center">
                    ...
                    <span
                        class="text-xs font-bold tracking-widest text-white">
                ...
                <p
                    class="mt-3 max-w-md text-xs leading-5
                ...
                <div class="mt-5 grid grid-cols-3 gap-2.5">
                    ...
                    <div
                        ...
                        <div
                            ...
                            <svg
                                class="relative h-6 w-6 text-blue-400"
                                fill="none"
                                stroke="currentColor"
                                viewBox="0 0 24 24">
                    ...
                    <!-- ================================================= -->
                    <!-- CARD 2 - REPORTAR (DOCUMENTO CON LUPA) -->
                    <!-- ================================================= -->
                    ...
                    <!-- ================================================= -->
                    <!-- CARD 3 - PROGRESO (BARRAS + FLECHA ASCENDENTE) -->
                    <!-- ================================================= -->
                    ...
                    <div
                        ...
                        <!-- ICONO: BARRAS CON FLECHA ASCENDENTE -->
                ...
                <p
                    class="mt-2 text-center text-[7px]
        ...
        <section
            class="relative hidden h-screen lg:block">

            <img
                src="{{ asset('storage/images/ticketpro-dashboard.png') }}"
                alt="TicketPro"
